    ...
    <AnimatePresence>
      {show && (
        <motion.button
          ...
          className="fixed bottom-6 left-1/2 transform -translate-x-1/2 z-50 font-semibold px-6 py-3 rounded-full shadow-lg flex items-center gap-2 text-base text-white bg-black dark:bg-white dark:text-black hover:bg-gray-100 dark:hover:bg-gray-800"
        >
